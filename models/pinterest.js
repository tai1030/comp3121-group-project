...
export default async function getData(keyword) {
  ...
  await new Promise(resolve => setTimeout(resolve, 1500)); //Just for demo, sleep(1500)

  let object = () => {
    return {
      title: "Test Pinterest title #" + randomInt(1, 9999),
      description:
        "Test Pinterest description! Do you want to find something about " +
        keyword +
        "?",
      photo:
